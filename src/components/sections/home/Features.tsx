...
Features.displayName = 'Features'
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Automated schema changes with rollback capabilities and data validation.',
      badge: 'Database',
    },
    {
      icon: Cloud,
    ...
    },
    {
      ...
      description: 'Real-time monitoring and analytics for system and application performance.',
      badge: 'Analytics',
    },
    {
      icon: Shield,
      title: 'Security Scanning',
      description: 'Automated vulnerability assessment and compliance checking for your code.',
      badge: 'Security',
    },
    {
      icon: Terminal,
    ...
    },
    {
      ...
      description: 'Automated deployment scheduling with environment-specific configurations.',
      badge: 'Automation',
    },
    {
      icon: Lock,
      title: 'Access Control',
      description: 'Role-based access control with detailed audit logging and compliance.',
      badge: 'Security',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Advanced tools and automation to help development teams deploy faster, more reliably,
